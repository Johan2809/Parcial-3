...
public class EstudianteController implements Initializable {
	...
	void mostrarEstudiantes(ActionEvent event) {
		for (Estudiante estudiante : listaEstudiantesDiplomado) {
			...
			JOptionPane.showMessageDialog(null, "Género: " + estudiante.getGenero());
			JOptionPane.showMessageDialog(null, "Identificación: " + estudiante.getIdentificacion());
	...
	void mostrarMejorEstudiante(ActionEvent event) {
		...
		if (mejorEstudiante != null) {
			...
			JOptionPane.showMessageDialog(null,
					"El estudiante con el promedio de notas más alto es: " + nombreMejorEstudiante);
		} else {
